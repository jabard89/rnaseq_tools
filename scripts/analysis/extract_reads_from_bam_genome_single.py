...
# version for single non-directional reads
# Jared Bard
# 03/03/2022
...
#	args = parser.parse_args()
	...
	gene_array = HTSeq.GenomicArrayOfSets("auto",stranded=False) # assuming no strand info
	...
	for gene in gene_ivs:
		...
		gene_array_dict[gene] = HTSeq.GenomicArrayOfSets("auto",stranded=False)
