...
files <- list.files(paste0(working.dir),
...
t$files %>% map2(t$names,function(file,name) {
  ...
  d_binned_byORF <- d_counts_binned %>%
    ...
    write_tsv(paste0("F:/Dropbox (Drummond Lab)/code_JB/repos/Polysome_seq/big/output_220303/counts/",name,"/211216_counts_bin100_",name,".tsv.gz"))
})
