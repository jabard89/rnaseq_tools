...
Adds chrom to the chromosomes in a GFF file (I -> chromI). Keeps the original comments at the tops and adds new ones
"""
...
if __name__ == '__main__':
	...
	for i,feature in enumerate(gtf_file):
		...
		feature.iv.chrom = args.chrom_prefix + chrom
